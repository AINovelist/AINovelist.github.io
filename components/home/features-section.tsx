...
const features: Feature[] = [
  {
    name: 'داستان‌های اختصاصی برای کودکان',
  ...
  {
    name: 'تجربه‌ای شخصی‌سازی‌شده و تعاملی',
    ...
    <section className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          با داستان‌هایی که به طور ویژه برای فرزند شما طراحی شده‌اند، همراه شوید. این قصه‌ها نام، سن و پیام‌های مهم زیست‌محیطی را با تخیل کودک ترکیب کرده و او را به دنیای هیجان‌انگیز و آموزنده‌ای دعوت می‌کنند.          </p>
        </div>
